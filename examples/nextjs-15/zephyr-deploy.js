...
async function main() {
  ...
  try {
    ...
    const { convertToZephyrAssets, createSnapshot, uploadSnapshot } = require('../../dist/libs/zephyr-nextjs-adapter/src/lib/core.js')
    const { createLogger } = require('../../dist/libs/zephyr-nextjs-adapter/src/lib/utils.js')
