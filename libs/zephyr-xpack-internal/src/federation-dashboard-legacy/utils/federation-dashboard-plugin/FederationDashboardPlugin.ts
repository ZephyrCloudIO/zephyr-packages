...
// In the ESM build the bundler rewrites this require() into a namespace
// import of the CJS module, which puts the function on `.default` — unwrap it
// so both output formats end up with the callable.
